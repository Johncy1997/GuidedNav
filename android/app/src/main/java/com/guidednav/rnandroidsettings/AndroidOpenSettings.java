...
public class AndroidOpenSettings extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void mobileDataSettings() {
    ...
    public void setFlashLight(boolean state) {
        if (getReactApplicationContext().getApplicationContext().getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_FLASH)) {
